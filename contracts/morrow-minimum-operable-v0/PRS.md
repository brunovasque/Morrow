...
| `P4-PR03` | `RUNNING` | P4-PR02 | Implementar replay/reidratação, cursores e liveness após restart | PR #21 em `https://github.com/brunovasque/Morrow/pull/21`, branch `mvo/p4-pr03-replay-rehydration`, base `phase-2/runtime-v0` em `cd7113febd147925cc5a5ab3557cb1d2ea48d1dc`; Execution Root `d63a19c2fb5da3fe8f781dba18b7abe75b9f4d7a`; opening Control Root/head `de47fd7a3f919a7094a16c051548cef0a47bf51a`; current Control Root/head anterior `8e819a9633f70c210b663db4edea53f6350ed347`; PR `OPEN`, não draft, mergeable; Security `GREEN`, Reviewer `GREEN` (`REVIEW_READY_FOR_AUDITOR`), Auditor pré-PR `GREEN` (`AUDIT_GREEN — P4_PR03_READY_FOR_INTEGRATOR`), Auditor pré-merge `MERGE_READY`; `MERGE_READY_MUST_BE_VERSIONED_BEFORE_MERGE` versionado; 16 paths, zero workflow/package drift, nenhum check automático reportado; merge autorizado sob as cercas aplicáveis; P4-PR03 ainda não está `PROVEN` |
