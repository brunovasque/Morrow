...
| `P3-PR04` | `RUNNING` | P3-PR03 | Provar multiplexing, cleanup, timeout/cancel e colisões sob múltiplas sessões | candidate local `ff744d2`; 3 rodadas/12 sessões ConPTY, input isolado, timeout/cancel distintos, 12 colisões recusadas, 24 PIDs encerrados, capacidade Windows medida em 2, probe `7/7` e suíte `159/159`; publicação/review remoto pendentes |
