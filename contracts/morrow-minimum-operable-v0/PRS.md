...
| `P4-PR02` | `RUNNING` | P4-PR01 | Implementar Stream Redactor, política de retenção e transcript persistente | candidate local `4773a5e` `GREEN_CANDIDATE`: canários/ANSI/Unicode/input/symlink/policy drift/retention/lease contraprovados, focados 8/8 e suíte 180/180; publicar e revisar remoto antes de merge |
