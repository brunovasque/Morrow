...
| `P2-PR04` | `READY` | P2-PR03 integrado | Implementar Routing/Access/Model registry, Quota Guard e Budget Guard mínimos | effective configuration auditável; concorrência/cota/budget bloqueiam sem downgrade/fallback silencioso |
