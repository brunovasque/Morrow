...
| `P3-PR02` | `RUNNING` | P3-PR01, P2-PR02 | Implementar backend ConPTY com input, resize, sinais, UTF-8 e exit status | candidate local `3a28b54`; PowerShell persistente real, UTF-8/VT, resize, Ctrl+C/Ctrl+Break, exit/drainage, árvore de processos isolada e 147 testes; aguarda PR e review remoto |
