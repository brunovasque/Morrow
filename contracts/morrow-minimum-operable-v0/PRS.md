...
| PR-ID | status | dependências | objetivo único | saída/prova de conclusão |
|---|---|---|---|---|
| `P4-PR01` | `RUNNING` | P2-PR06, P3-PR02 | Definir eventos canônicos e projector do Live Activity Feed | candidate `6bbe7cd` + hardening `375da19`: schema `morrow.live-activity/1.0`, dez estados AC-21, ordem/identidade/causalidade/coleção fail-closed, input hostil sanitizado, focados 8/8 e suíte 172/172; publicar/revisar remoto antes de integrar |
