...
| PR-ID | status | dependências | objetivo único | saída/prova de conclusão |
|---|---|---|---|---|
| `P3-PR01` | `RUNNING` | P2-PR01/02 | Fazer spike/ADR de PTY/ConPTY e criar interface de backend com capability gate | decisão state-of-art, backend process-pipes preservado e UI impedida de chamá-lo de terminal completo |
