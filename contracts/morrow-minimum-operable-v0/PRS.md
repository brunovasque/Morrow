...
| `P3-PR04` | `RUNNING` | P3-PR03 | Provar multiplexing, cleanup, timeout/cancel e colisões sob múltiplas sessões | PR #14 `GREEN_CANDIDATE` local `c9ade54f`: addon isolado por sessão/host; saída simultânea e crash contido contraprovados; ConPTY 10/10, suíte 163/163, soak 12 sessões/12 hosts/noOrphans; publicar e revisar SHA remoto exato antes de integrar |
