...
| `P2-PR03` | `RUNNING` | P2-PR02 integrado | Implementar registries/resolvers mínimos de Target, Role, Skill e Capability mais Secret Broker boundary | dispatch sem target/role/skill/capability/secret policy válido é recusado e nenhuma credencial entra no contexto indevido |
