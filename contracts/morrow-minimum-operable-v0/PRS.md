...
| `P3-PR02` | `RUNNING` | P3-PR01, P2-PR02 | Implementar backend ConPTY com input, resize, sinais, UTF-8 e exit status | PR #12; hardening adversarial `29974cf`; ambiente governado sem herança do operador, PowerShell persistente real, UTF-8/VT, resize, Ctrl+C/Ctrl+Break, exit após handles, drainage de 512 KiB, árvore isolada e 149 testes; aguarda publicação/revalidação remota |
