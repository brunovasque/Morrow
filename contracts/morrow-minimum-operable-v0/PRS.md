...
| `P3-PR04` | `RUNNING` | P3-PR03 | Provar multiplexing, cleanup, timeout/cancel e colisões sob múltiplas sessões | PRE_DISPATCH na base integrada `5624e2a`; executar soak concorrente sem processo órfão, workspace compartilhado, perda de identidade ou colisão aceita |
