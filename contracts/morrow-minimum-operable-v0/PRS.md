...
| `P3-PR04` | `RUNNING` | P3-PR03 | Provar multiplexing, cleanup, timeout/cancel e colisões sob múltiplas sessões | PR #14 `GREEN` no remoto `e686882`: addon isolado por sessão/host e IPC fail-closed; saída simultânea, crash contido e protocolo inválido contraprovados; ConPTY 11/11, suíte 164/164, soak 12 sessões/12 hosts/noOrphans; integrar e executar regressão pós-merge antes de `PROVEN` |
