...
| `P4-PR02` | `RUNNING` | P4-PR01 | Implementar Stream Redactor, política de retenção e transcript persistente | suíte injeta segredos e prova ausência antes de storage/UI |
