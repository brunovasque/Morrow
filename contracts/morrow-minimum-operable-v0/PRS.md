...
| `P3-PR03` | `RUNNING` | P3-PR02, P1-PR03 | Executar Codex quota-session pelo terminal gerenciado sem extrair credencial/API | PRE_DISPATCH na base `1d40eb7`; provar sessão autenticada via ConPTY, stream ao vivo, cwd isolado e metadata do runtime sem fallback API |
