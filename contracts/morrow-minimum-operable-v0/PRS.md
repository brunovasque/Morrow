...
| `P4-PR03` | `RUNNING` | P4-PR02 | Implementar replay/reidratação, cursores e liveness após restart | Execution Root `d63a19c2fb5da3fe8f781dba18b7abe75b9f4d7a`, parent `ea4bcaa9fd8d2b3de0f079ac05f3ba00165a3d1b`, base `cd7113febd147925cc5a5ab3557cb1d2ea48d1dc`, branch `mvo/p4-pr03-replay-rehydration`; Security Review GREEN; Reviewer independente `REVIEW_READY_FOR_AUDITOR`; primeira auditoria `AUDIT_BLOCKED` somente por documentation, independence evidence e authorization; documentação reconciliada; aguarda recheck do mesmo Auditor; Integrator proibido até `AUDIT_GREEN — P4_PR03_READY_FOR_INTEGRATOR` |
