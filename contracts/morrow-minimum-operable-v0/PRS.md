...
| `P4-PR03` | `RUNNING` | P4-PR02 | Implementar replay/reidratação, cursores e liveness após restart | kickoff/PRE_DISPATCH na base `cd7113febd147925cc5a5ab3557cb1d2ea48d1dc`, branch `mvo/p4-pr03-replay-rehydration`; cliente retoma sem duplicar/perder eventos e distingue esperas/falhas; D-014..D-017 obrigatórios; Security Review normal independente obrigatório antes da integração |
