...
| `P4-PR02` | `RUNNING` | P4-PR01 | Implementar Stream Redactor, política de retenção e transcript persistente | PR #18: A-001 de `ba350658` ficou `BLOCKED` por P2 de bypass HPA + DCH; `ba350658` está superseded/invalidated pelo candidate real `dc0bbafbcf5c5b2b07f6ccddec081a465f296fcf`. A correção estrutural usa allowlist CSI com fail-closed para mutável/desconhecido/não comprovado; o efeito colateral 7-bit/C1 foi detectado antes do commit e corrigido. Provas finais: focused 31/31, controle ConPTY GREEN, regressão completa 203/203 e `git diff --check` GREEN. O novo candidate ainda não possui A-001 válido; P4-PR02 segue `BLOCKED ON A-001`, merge/regressão pós-merge permanecem proibidos/pendentes, D-013 permanece aberto e P4-PR03 não é autorizada |
