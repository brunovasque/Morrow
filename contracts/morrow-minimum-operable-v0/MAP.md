...
- A unidade ativa é P4-PR03, iniciada em `RUNNING` na base integrada `cd7113febd147925cc5a5ab3557cb1d2ea48d1dc`, branch `mvo/p4-pr03-replay-rehydration`, com objetivo de replay/reidratação, cursores e liveness após restart. A closure-record da PR #19 já está integrada e não é unidade contratual nova nem contém código/runtime/testes; P4-PR04 permanece fora de escopo.
