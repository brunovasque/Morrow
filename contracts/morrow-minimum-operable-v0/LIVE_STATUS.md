...
|---|---|---|---|
| `P4-PR02-P2-001` | A-001 security gate | A revisão do candidate `15e3ac7` encontrou bypass de redaction por reconstrução VT CSI `b` / REP; a correção foi criada em `ba350658a39f270cbc9ec559c193997a1a0db047`, mas o A-001 completo ainda não foi executado no candidate novo | re-review independente, somente-leitura e fixado em `3657a070e5dc6b1e7b78fa1804761440c55efffc..ba350658a39f270cbc9ec559c193997a1a0db047`; não fazer merge antes de veredito sem P1/P2 |
...
| P4 | `RUNNING` | P4-PR02 `BLOCKED ON A-001`; `a44daee` e `15e3ac7` são predecessors superseded/invalidated e `ba35065` é o candidate atual; re-review local independente, merge e regressão pós-merge pendentes |
