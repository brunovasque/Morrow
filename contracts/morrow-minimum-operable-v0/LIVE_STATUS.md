...
|---|---|---|---|
| `P4-PR02-P2-001` | A-001 security gate | O A-001 do candidate `95e808` foi executado e ficou `BLOCKED` por dois P2; `95e808` está superseded/invalidated e o candidate `189c1ce` ainda não tem A-001 válido | re-review independente, somente-leitura e fixado em `3657a070e5dc6b1e7b78fa1804761440c55efffc..189c1ced569489508ceb7d052f5e2b521cf085dd`; não fazer merge antes de veredito sem P1/P2 |
...
| P4 | `RUNNING` | P4-PR02 `BLOCKED ON A-001`; `a44daee`, `15e3ac7`, `ba35065`, `dc0bbaf` e `95e808` são predecessors superseded/invalidated e `189c1ce` é o candidate atual; re-review local independente, merge e regressão pós-merge pendentes |
