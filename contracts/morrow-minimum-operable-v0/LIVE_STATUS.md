...
|---|---|---|---|
| `P4-PR02-P2-001` | A-001 security gate | A revisão do candidate `ba350658` encontrou bypass de redaction por composição HPA + DCH; a correção estrutural foi criada em `dc0bbafbcf5c5b2b07f6ccddec081a465f296fcf`, mas o A-001 completo ainda não foi executado no candidate novo | re-review independente, somente-leitura e fixado em `3657a070e5dc6b1e7b78fa1804761440c55efffc..dc0bbafbcf5c5b2b07f6ccddec081a465f296fcf`; não fazer merge antes de veredito sem P1/P2 |
...
| P4 | `RUNNING` | P4-PR02 `BLOCKED ON A-001`; `a44daee`, `15e3ac7` e `ba35065` são predecessors superseded/invalidated e `dc0bbaf` é o candidate atual; re-review local independente, merge e regressão pós-merge pendentes |
