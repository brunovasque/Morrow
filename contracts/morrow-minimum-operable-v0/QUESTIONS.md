...
- bloqueio atual: nenhum; correções da revisão adversarial P3-PR02 passaram probe nativo e suíte local, mas a unidade continua `RUNNING` até publicação, revalidação remota e integração
