...
- bloqueio atual: nenhum; P3-PR02 passou o probe nativo e a suíte local, mas continua `RUNNING` até publicação, review remoto, correções e integração
