...
- bloqueio atual: nenhum; P4-PR02 está `GREEN_CANDIDATE` local após dois passes remotos e hardenings adversariais, aguardando publicação/revalidação, merge e regressão pós-merge
