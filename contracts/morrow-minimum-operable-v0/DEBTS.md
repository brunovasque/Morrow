...
| `D-013` | P4-PR02 regression | soak P3 exige unicidade global de PID entre hosts/descendentes já encerrados | ocorrências `conpty_soak_native_host_pid_collision` (179/180) e `conpty_soak_descendant_pid_collision` (182/183); controles imediatos passaram 3 rodadas/12 sessões, 12 root/descendant/native-host PIDs, 51 eventos, noOrphans/fixtureRemoved; suítes seguintes passaram 180/180 e 183/183 | cross-cutting-test-harness | falso vermelho intermitente quando o Windows reutiliza PID após exit | `OPEN_DEBT` | corrigir em unidade própria sem alterar P3 oportunisticamente dentro da P4-PR02; preservar unicidade simultânea e isolamento real | none | 2026-08-31 |
