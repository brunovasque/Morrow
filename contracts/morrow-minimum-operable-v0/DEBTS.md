...
| `D-013` | P4-PR02 regression | soak P3 exige unicidade global de PID entre hosts já encerrados | uma suíte remota-exata ficou 179/180 em `conpty_soak_native_host_pid_collision`; zero fingerprints Morrow órfãos; controle imediato passou 3 rodadas/12 sessões/12 native hosts/noOrphans e a suíte seguinte passou 180/180 | cross-cutting-test-harness | falso vermelho intermitente quando o Windows reutiliza PID após exit | `OPEN_DEBT` | corrigir em unidade própria sem alterar P3 oportunisticamente dentro da P4-PR02; preservar unicidade simultânea e isolamento real | none | 2026-08-31 |
