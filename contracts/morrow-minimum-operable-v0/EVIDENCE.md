...
| `P2-PR02` | `7b6ad6b` | código/teste `9784489` | `mvo/p2-pr02-worker-service`; PR remota pendente de publicação | serviço Local Worker configurável, raízes marcadas, start/stop/status, diagnóstico e host reiniciável; `npm test` 55/55; `git diff --check` verde; sem target, dispatch, shell, rede ou credencial | revisão interna de arquitetura/segurança `GREEN_CANDIDATE` em `reviews/P2-PR02.md`; revisão remota obrigatória antes de `PROVEN` | `RUNNING` | 2026-08-28 |
