...
| `P2-PR01` | `37f28da` | `b9e7315` | `mvo/p2-pr01-worker-protocol`; PR `PENDING` | ADR + schema + decoder; `npm test` 48/48; compatibilidade, auth binding, scope, replay, ordering, TTL e body estrito atacados; `git diff --check` verde | Architect/Security Reviewer/Reviewer: `GREEN_CANDIDATE`; aguarda PR real e conferência do head | `RUNNING` | 2026-08-28 |
