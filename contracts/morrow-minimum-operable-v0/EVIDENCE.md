...
| `P2-PR04` | `7d3e91b` | `PENDING` | `mvo/p2-pr04-routing-guards` | PRE_DISPATCH: configuração efetiva e auditável de routing/access/model/effort; Quota Guard e Budget Guard mínimos; sem fallback/downgrade silencioso, dispatch, processo, rede ou cobrança real | Architect/Executor em execução; Security Reviewer e Reviewer obrigatórios antes de `PROVEN` | `RUNNING` | 2026-08-29 |
