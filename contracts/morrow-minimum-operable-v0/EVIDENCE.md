...
| `P2-PR02` | `7b6ad6b` | `PENDING` | `mvo/p2-pr02-worker-service` | PRE_DISPATCH: serviço Local Worker configurável, managed roots, start/stop/status e diagnóstico; nenhum dispatch, shell, rede, credencial ou target | Executor em execução; Security Reviewer e Reviewer obrigatórios antes de PROVEN | `RUNNING` | 2026-08-28 |
