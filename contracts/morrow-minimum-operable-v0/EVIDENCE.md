...
| `P2-PR03` | `330bfa1` | `PENDING` | `mvo/p2-pr03-registries` | PRE_DISPATCH: registries/resolvers estritos de Target, Role, Skill e Capability e fronteira opaca do Secret Broker; nenhuma credencial real, dispatch, shell, rede ou target externo | Architect/Executor em execução; Security Reviewer e Reviewer obrigatórios antes de `PROVEN` | `RUNNING` | 2026-08-28 |
