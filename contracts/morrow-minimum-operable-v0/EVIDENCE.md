...
| `P2-PR06` | `9b96a8b` | `PENDING` | `mvo/p2-pr06-recovery`; PR remota pendente | objetivo: reconnect, retry idempotente, fila, checkpoint e online/offline; provas planejadas: kill/restart sem efeito duplicado, pendência retomada ou bloqueada com causa explícita, corrupção/replay recusados, `npm test`, testes focados e `git diff --check`; sem ConPTY, rede concreta, credencial ou target externo | Architect/Security Reviewer/Reviewer: `PENDING` | `RUNNING` | 2026-08-29 |
