...
| `P2-PR05` | `aba8770` | `PENDING` | `mvo/p2-pr05-authenticated-dispatch` | PRE_DISPATCH: ligar envelope autenticado, WorkAuthority, routing/quota/budget, lock e workspace antes de executar PowerShell determinístico ou AgentInstance; fixtures locais somente; sem ConPTY, retry persistente, credencial, rede ou target externo | Architect/Executor em execução; Security Reviewer e Reviewer obrigatórios antes de `PROVEN` | `RUNNING` | 2026-08-29 |
