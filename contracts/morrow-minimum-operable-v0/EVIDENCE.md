...
| `P2-PR01` | `37f28da` | `PENDING` | `mvo/p2-pr01-worker-protocol` | PRE_DISPATCH: schema/ADR + compatibilidade e recusa mecânica; sem processo, shell, rede, credencial ou target externo | Architect em execução; Security Reviewer e Reviewer obrigatórios antes de PROVEN | `RUNNING` | 2026-08-28 |
