...
- timeout/cancel concorrente, colisões e múltiplas sessões estão `GREEN_CANDIDATE` na P3-PR04 com addon isolado por host e documentados em `CONPTY_MULTIPLEXING.md`;
